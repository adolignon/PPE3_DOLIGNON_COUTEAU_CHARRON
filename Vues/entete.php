<html>
	...
	<body>        
        ...
        <a href="index.php?vue=compte&action=menu" class="navbar-brand"><img src="Images/logo.jpg" alt="Videotheque"><br/><span class="text-red text-small">Vos vidéos<br/>en un clic</span></a>
